  ...
  return [
    {
      ...
      controller: {
        wingDoctrine: {
          ...
          replanMs: 120,
          homeBlend: 0.28,
          anchorWeightFloor: 0.50,
          anchorWeightCeil: 0.96,
          leadDistancePx: 124,
          rangeFloorPx: 92,
          rangeCeilPx: 196,
          intraVolleyMs: 120,
      ...
      planes: makeRaptorPlanes(2, () => ({ fireRateModifier: 1.35 })),
    },
    {
    ...
    },
    {
      ...
      controller: {
        wingDoctrine: {
          ...
          replanMs: 120,
          homeBlend: 0.32,
          anchorWeightFloor: 0.54,
          anchorWeightCeil: 0.98,
          leadDistancePx: 116,
          rangeFloorPx: 98,
          rangeCeilPx: 204,
          intraVolleyMs: 135,
      ...
      planes: makeRaptorPlanes(2, () => ({ fireRateModifier: 1.45 })),
    },
    {
